...
| Visual architecture (Mermaid) | [`docs/architecture-diagrams.md`](./architecture-diagrams.md) | System context, sequence, `require_auth` decision tree, JWKS cache state machine, config topology, failure-mode map |
